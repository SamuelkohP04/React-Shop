                        ...
                        <Sheet>
                            <div className="flex gap-8 max-lg:gap-4">
                                <SheetTrigger className="flex items-center gap-4">
                                    ...
                                    <div className="w-8 h-8 flex justify-center items-center bg-white rounded-full text-base">{Object.keys(cart).length}</div>
                                </SheetTrigger>
                            ...
                            <SheetContent className="flex flex-col justify-between bg-neutral-200 overflow-scroll pb-0">
                                <SheetHeader className="flex flex-col gap-4">
                                    <div>
                                        ...
                                        <SheetDescription>
                                            You have {Object.keys(cart).length} {Object.keys(cart).length === 1 ? "item" : "items"} in your cart
                                        </SheetDescription>
                                    </div>
